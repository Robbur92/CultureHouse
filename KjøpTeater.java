 ...
 * Klassens hensikt er å utføre et kjøp av billett til teater
 */
...
public class KjøpTeater extends JFrame
{
	/**
	 * 
	 */
	...
	public void nyPerson()
	{
		...
		String arrangement = "Kjøpte billett til Teater: " + teater.getSelectedItem() + " for kr " + regnUtPris();
